...
| -------------------------- | ------- | -------- |
| [Messages](#messages)      | 8       | 235      |
| [Enums](#enumerated-types) | 13      | 160      |
...
| gpsLat          | `int32_t`  | degE7 |                                                                                                                                                                                  | Latitude WGS84 (deg \* 1E7). 如果未知设置为 UINT32_MAX                                                                                                                                                |
| gpsLon          | `int32_t`  | degE7 |                                                                                                                                                                                  | Longitude WGS84 (deg \* 1E7). 如果未知设置为 UINT32_MAX                                                                                                                                               |
...
| baroAltMSL      | `int32_t`  | 毫巴    |                                                                                                                                                                                  | Barometric pressure altitude (MSL) relative to a standard atmosphere of 1013.2 mBar and NOT bar corrected altitude (m \* 1E-3). （up +ve）。如果未知设置为 UINT32_MAX |
| accuracyHor     | `uint32_t` | 毫米    |                                                                                                                                                                                  | Horizontal accuracy in mm (m \* 1E-3). 如果未知设置为 UINT32_MAX                                                                                                                                      |
| accuracyVert    | `uint16_t` | 厘米    |                                                                                                                                                                                  | 以厘米为单位的垂直精度。如果未知设置为 UINT16_MAX                                                                                                                                                                                                    |
| accuracyVel     | `uint16_t` | 毫米/秒  |                                                                                                                                                                                  | Velocity accuracy in mm/s (m \* 1E-3). 如果未知设置为 UINT16_MAX                                                                                                                                      |
