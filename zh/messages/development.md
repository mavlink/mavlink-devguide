...
*This is a human-readable form of the XML definition file: [development](https://github.com/mavlink/mavlink/blob/master/message_definitions/v1.0/development).*
...
{% include "_html/development.html" %}
