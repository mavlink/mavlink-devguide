...
This dialect contains messages that are proposed for inclusion in the [standard set](standard.md), in order to ease development of prototype implementations. They should be considered a 'work in progress' and not included in production builds. They should be considered a 'work in progress' and not included in production builds.
...
| ----------------------- | ------- | -------- |
| [消息](#messages)         | 16      | 226      |
| [枚举](#enumerated-types) | 15      | 144      |
| [命令](#mav_commands)     | 173     | 0        |
