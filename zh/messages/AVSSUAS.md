...
This is a human-readable form of the XML definition file: [AVSSUAS](https://github.com/mavlink/mavlink/blob/master/message_definitions/v1.0/AVSSUAS).
...
| -------------------------- | ------- | -------- |
| [Messages](#messages)      | 4       | 225      |
| [Enums](#enumerated-types) | 3       | 143      |
