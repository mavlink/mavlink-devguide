...
These wrappers typically provide implementations of the main MAVLink [microservices](../services/README.md) and simple/specific interfaces for sending commands and accessing vehicle information. 
