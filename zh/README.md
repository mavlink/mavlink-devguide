...
* 可靠性。 自2009年以来, MAVLink一直被用于多种载具、地面站 (和其他节点) 之间的通信，这些通信信道中，不乏各种挑战性的 (高延迟/噪声) 。 It provides methods for detecting packet drops, corruption, and for packet authentication.
