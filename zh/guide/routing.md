...
Unsigned MAVLink 2 packets are routed in the same way as MAVLink 1 packets. Signed packets may have some special routing requirements (see [Routing Signed Packets](#routing_signed_packets) below).
