...
`n=0`: NA, `n=1`: 10, `n=2`: 10-11, `n>2`: 10 to 9+n | `uint8_t payload[max 255]` | [负载](#payload)                    |              | 消息数据。 取决于消息类型 (即消息 ID) 和内容。                                                                                                                                                                                                                                                                               |
...
`n=0`: NA, `n=1`: 6, `n=2`: 6 to 7, `n>2`: 6 to 5+n | `uint8_t payload[max 255]` | 有效负载数据                          |                   | 消息数据。 内容取决于消息类型(即消息ID)。                                                                                                                                                                                                                                    |
