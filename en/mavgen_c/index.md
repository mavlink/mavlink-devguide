...
If you are using [standard definitions](../messages/index.md) or a [dialect](../messages/dialects.md#dialects) published in the MAVLink repository then download the _MAVLink 2_ library from Github: [c_library_v2](https://github.com/mavlink/c_library_v2).
