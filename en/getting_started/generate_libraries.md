...
1. If you are generating messages for a [custom dialect](../messages/dialects.md), copy the dialect XML definition file(s) into the directory [message_definitions/v1.0/](https://github.com/mavlink/mavlink/tree/master/message_definitions/v1.0).
