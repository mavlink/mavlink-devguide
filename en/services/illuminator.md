...
The mode value as 1 indicates `ILLUMINATOR_MODE_INTERNAL_CONTROL` where the illuminator behavior is controlled by [MAV_CMD_DO_ILLUMINATOR_CONFIGURE](#MAV_CMD_DO_ILLUMINATOR_CONFIGURE) settings.
