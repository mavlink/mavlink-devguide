...
If you need [standard definitions](../messages/index.md) or a [dialect](../messages/dialects.md#dialects) published in the MAVLink repository then you can install these (for both MAVLink 1 and 2) with _pymavlink_ using _pip_:
