...
- Messages: [PARAM_ACK_TRANSACTION](#PARAM_ACK_TRANSACTION), [AIRSPEED](#AIRSPEED), [WIFI_NETWORK_INFO](#WIFI_NETWORK_INFO), [SET_VELOCITY_LIMITS](#SET_VELOCITY_LIMITS), [VELOCITY_LIMITS](#VELOCITY_LIMITS), [FIGURE_EIGHT_EXECUTION_STATUS](#FIGURE_EIGHT_EXECUTION_STATUS), [BATTERY_STATUS_V2](#BATTERY_STATUS_V2), [GROUP_START](#GROUP_START), [GROUP_END](#GROUP_END), [RADIO_RC_CHANNELS](#RADIO_RC_CHANNELS), [AVAILABLE_MODES](#AVAILABLE_MODES), [CURRENT_MODE](#CURRENT_MODE), [AVAILABLE_MODES_MONITOR](#AVAILABLE_MODES_MONITOR), [TARGET_ABSOLUTE](#TARGET_ABSOLUTE), [TARGET_RELATIVE](#TARGET_RELATIVE)

- Enums: [WIFI_NETWORK_SECURITY](#WIFI_NETWORK_SECURITY), [AIRSPEED_SENSOR_FLAGS](#AIRSPEED_SENSOR_FLAGS), [PARAM_TRANSACTION_TRANSPORT](#PARAM_TRANSACTION_TRANSPORT), [PARAM_TRANSACTION_ACTION](#PARAM_TRANSACTION_ACTION), [MAV_STANDARD_MODE](#MAV_STANDARD_MODE), [MAV_MODE_PROPERTY](#MAV_MODE_PROPERTY), [MAV_BATTERY_STATUS_FLAGS](#MAV_BATTERY_STATUS_FLAGS), [TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS](#TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS), [TARGET_OBS_FRAME](#TARGET_OBS_FRAME), [RADIO_RC_CHANNELS_FLAGS](#RADIO_RC_CHANNELS_FLAGS)

- Commands: [MAV_CMD_DO_FIGURE_EIGHT](#MAV_CMD_DO_FIGURE_EIGHT), [MAV_CMD_DO_UPGRADE](#MAV_CMD_DO_UPGRADE), [MAV_CMD_DO_SET_STANDARD_MODE](#MAV_CMD_DO_SET_STANDARD_MODE), [MAV_CMD_GROUP_START](#MAV_CMD_GROUP_START), [MAV_CMD_GROUP_END](#MAV_CMD_GROUP_END), [MAV_CMD_SET_AT_S_PARAM](#MAV_CMD_SET_AT_S_PARAM), [MAV_CMD_DO_SET_SYS_CMP_ID](#MAV_CMD_DO_SET_SYS_CMP_ID), [MAV_CMD_PARAM_TRANSACTION](#MAV_CMD_PARAM_TRANSACTION), [MAV_CMD_ODID_SET_EMERGENCY](#MAV_CMD_ODID_SET_EMERGENCY)
