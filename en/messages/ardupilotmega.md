...
- Messages: [SENSOR_OFFSETS](#SENSOR_OFFSETS), [SET_MAG_OFFSETS](#SET_MAG_OFFSETS), [MEMINFO](#MEMINFO), [AP_ADC](#AP_ADC), [DIGICAM_CONFIGURE](#DIGICAM_CONFIGURE), [DIGICAM_CONTROL](#DIGICAM_CONTROL), [MOUNT_CONFIGURE](#MOUNT_CONFIGURE), [MOUNT_CONTROL](#MOUNT_CONTROL), [MOUNT_STATUS](#MOUNT_STATUS), [FENCE_POINT](#FENCE_POINT), [FENCE_FETCH_POINT](#FENCE_FETCH_POINT), [AHRS](#AHRS), [SIMSTATE](#SIMSTATE), [HWSTATUS](#HWSTATUS), [RADIO](#RADIO), [LIMITS_STATUS](#LIMITS_STATUS), [WIND](#WIND), [DATA16](#DATA16), [DATA32](#DATA32), [DATA64](#DATA64), [DATA96](#DATA96), [RANGEFINDER](#RANGEFINDER), [AIRSPEED_AUTOCAL](#AIRSPEED_AUTOCAL), [RALLY_POINT](#RALLY_POINT), [RALLY_FETCH_POINT](#RALLY_FETCH_POINT), [COMPASSMOT_STATUS](#COMPASSMOT_STATUS), [AHRS2](#AHRS2), [CAMERA_STATUS](#CAMERA_STATUS), [CAMERA_FEEDBACK](#CAMERA_FEEDBACK), [BATTERY2](#BATTERY2), [AHRS3](#AHRS3), [AUTOPILOT_VERSION_REQUEST](#AUTOPILOT_VERSION_REQUEST), [REMOTE_LOG_DATA_BLOCK](#REMOTE_LOG_DATA_BLOCK), [REMOTE_LOG_BLOCK_STATUS](#REMOTE_LOG_BLOCK_STATUS), [LED_CONTROL](#LED_CONTROL), [MAG_CAL_PROGRESS](#MAG_CAL_PROGRESS), [EKF_STATUS_REPORT](#EKF_STATUS_REPORT), [PID_TUNING](#PID_TUNING), [DEEPSTALL](#DEEPSTALL), [GIMBAL_REPORT](#GIMBAL_REPORT), [GIMBAL_CONTROL](#GIMBAL_CONTROL), [GIMBAL_TORQUE_CMD_REPORT](#GIMBAL_TORQUE_CMD_REPORT), [GOPRO_HEARTBEAT](#GOPRO_HEARTBEAT), [GOPRO_GET_REQUEST](#GOPRO_GET_REQUEST), [GOPRO_GET_RESPONSE](#GOPRO_GET_RESPONSE), [GOPRO_SET_REQUEST](#GOPRO_SET_REQUEST), [GOPRO_SET_RESPONSE](#GOPRO_SET_RESPONSE), [RPM](#RPM), [DEVICE_OP_READ](#DEVICE_OP_READ), [DEVICE_OP_READ_REPLY](#DEVICE_OP_READ_REPLY), [DEVICE_OP_WRITE](#DEVICE_OP_WRITE), [DEVICE_OP_WRITE_REPLY](#DEVICE_OP_WRITE_REPLY), [ADAP_TUNING](#ADAP_TUNING), [VISION_POSITION_DELTA](#VISION_POSITION_DELTA), [AOA_SSA](#AOA_SSA), [ESC_TELEMETRY_1_TO_4](#ESC_TELEMETRY_1_TO_4), [ESC_TELEMETRY_5_TO_8](#ESC_TELEMETRY_5_TO_8), [ESC_TELEMETRY_9_TO_12](#ESC_TELEMETRY_9_TO_12), [OSD_PARAM_CONFIG](#OSD_PARAM_CONFIG), [OSD_PARAM_CONFIG_REPLY](#OSD_PARAM_CONFIG_REPLY), [OSD_PARAM_SHOW_CONFIG](#OSD_PARAM_SHOW_CONFIG), [OSD_PARAM_SHOW_CONFIG_REPLY](#OSD_PARAM_SHOW_CONFIG_REPLY), [OBSTACLE_DISTANCE_3D](#OBSTACLE_DISTANCE_3D), [WATER_DEPTH](#WATER_DEPTH), [MCU_STATUS](#MCU_STATUS)

- Enums: [ACCELCAL_VEHICLE_POS](#ACCELCAL_VEHICLE_POS), [HEADING_TYPE](#HEADING_TYPE), [SCRIPTING_CMD](#SCRIPTING_CMD), [LIMITS_STATE](#LIMITS_STATE), [LIMIT_MODULE](#LIMIT_MODULE), [RALLY_FLAGS](#RALLY_FLAGS), [CAMERA_STATUS_TYPES](#CAMERA_STATUS_TYPES), [CAMERA_FEEDBACK_FLAGS](#CAMERA_FEEDBACK_FLAGS), [MAV_MODE_GIMBAL](#MAV_MODE_GIMBAL), [GIMBAL_AXIS](#GIMBAL_AXIS), [GIMBAL_AXIS_CALIBRATION_STATUS](#GIMBAL_AXIS_CALIBRATION_STATUS), [GIMBAL_AXIS_CALIBRATION_REQUIRED](#GIMBAL_AXIS_CALIBRATION_REQUIRED), [GOPRO_HEARTBEAT_STATUS](#GOPRO_HEARTBEAT_STATUS), [GOPRO_HEARTBEAT_FLAGS](#GOPRO_HEARTBEAT_FLAGS), [GOPRO_REQUEST_STATUS](#GOPRO_REQUEST_STATUS), [GOPRO_COMMAND](#GOPRO_COMMAND), [GOPRO_CAPTURE_MODE](#GOPRO_CAPTURE_MODE), [GOPRO_RESOLUTION](#GOPRO_RESOLUTION), [GOPRO_FRAME_RATE](#GOPRO_FRAME_RATE), [GOPRO_FIELD_OF_VIEW](#GOPRO_FIELD_OF_VIEW), [GOPRO_VIDEO_SETTINGS_FLAGS](#GOPRO_VIDEO_SETTINGS_FLAGS), [GOPRO_PHOTO_RESOLUTION](#GOPRO_PHOTO_RESOLUTION), [GOPRO_PROTUNE_WHITE_BALANCE](#GOPRO_PROTUNE_WHITE_BALANCE), [GOPRO_PROTUNE_COLOUR](#GOPRO_PROTUNE_COLOUR), [GOPRO_PROTUNE_GAIN](#GOPRO_PROTUNE_GAIN), [GOPRO_PROTUNE_SHARPNESS](#GOPRO_PROTUNE_SHARPNESS), [GOPRO_PROTUNE_EXPOSURE](#GOPRO_PROTUNE_EXPOSURE), [GOPRO_CHARGING](#GOPRO_CHARGING), [GOPRO_MODEL](#GOPRO_MODEL), [GOPRO_BURST_RATE](#GOPRO_BURST_RATE), [MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL](#MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL), [LED_CONTROL_PATTERN](#LED_CONTROL_PATTERN), [EKF_STATUS_FLAGS](#EKF_STATUS_FLAGS), [PID_TUNING_AXIS](#PID_TUNING_AXIS), [MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS](#MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS), [MAV_REMOTE_LOG_DATA_BLOCK_STATUSES](#MAV_REMOTE_LOG_DATA_BLOCK_STATUSES), [DEVICE_OP_BUSTYPE](#DEVICE_OP_BUSTYPE), [DEEPSTALL_STAGE](#DEEPSTALL_STAGE), [PLANE_MODE](#PLANE_MODE), [COPTER_MODE](#COPTER_MODE), [SUB_MODE](#SUB_MODE), [ROVER_MODE](#ROVER_MODE), [TRACKER_MODE](#TRACKER_MODE), [OSD_PARAM_CONFIG_TYPE](#OSD_PARAM_CONFIG_TYPE), [OSD_PARAM_CONFIG_ERROR](#OSD_PARAM_CONFIG_ERROR)

- Commands: [MAV_CMD_NAV_ALTITUDE_WAIT](#MAV_CMD_NAV_ALTITUDE_WAIT), [MAV_CMD_DO_SET_RESUME_REPEAT_DIST](#MAV_CMD_DO_SET_RESUME_REPEAT_DIST), [MAV_CMD_DO_SPRAYER](#MAV_CMD_DO_SPRAYER), [MAV_CMD_DO_SEND_SCRIPT_MESSAGE](#MAV_CMD_DO_SEND_SCRIPT_MESSAGE), [MAV_CMD_DO_AUX_FUNCTION](#MAV_CMD_DO_AUX_FUNCTION), [MAV_CMD_POWER_OFF_INITIATED](#MAV_CMD_POWER_OFF_INITIATED), [MAV_CMD_SOLO_BTN_FLY_CLICK](#MAV_CMD_SOLO_BTN_FLY_CLICK), [MAV_CMD_SOLO_BTN_FLY_HOLD](#MAV_CMD_SOLO_BTN_FLY_HOLD), [MAV_CMD_SOLO_BTN_PAUSE_CLICK](#MAV_CMD_SOLO_BTN_PAUSE_CLICK), [MAV_CMD_FIXED_MAG_CAL](#MAV_CMD_FIXED_MAG_CAL), [MAV_CMD_FIXED_MAG_CAL_FIELD](#MAV_CMD_FIXED_MAG_CAL_FIELD), [MAV_CMD_SET_EKF_SOURCE_SET](#MAV_CMD_SET_EKF_SOURCE_SET), [MAV_CMD_DO_START_MAG_CAL](#MAV_CMD_DO_START_MAG_CAL), [MAV_CMD_DO_ACCEPT_MAG_CAL](#MAV_CMD_DO_ACCEPT_MAG_CAL), [MAV_CMD_DO_CANCEL_MAG_CAL](#MAV_CMD_DO_CANCEL_MAG_CAL), [MAV_CMD_SET_FACTORY_TEST_MODE](#MAV_CMD_SET_FACTORY_TEST_MODE), [MAV_CMD_DO_SEND_BANNER](#MAV_CMD_DO_SEND_BANNER), [MAV_CMD_ACCELCAL_VEHICLE_POS](#MAV_CMD_ACCELCAL_VEHICLE_POS), [MAV_CMD_GIMBAL_RESET](#MAV_CMD_GIMBAL_RESET), [MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS](#MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS), [MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION](#MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION), [MAV_CMD_GIMBAL_FULL_RESET](#MAV_CMD_GIMBAL_FULL_RESET), [MAV_CMD_FLASH_BOOTLOADER](#MAV_CMD_FLASH_BOOTLOADER), [MAV_CMD_BATTERY_RESET](#MAV_CMD_BATTERY_RESET), [MAV_CMD_DEBUG_TRAP](#MAV_CMD_DEBUG_TRAP), [MAV_CMD_SCRIPTING](#MAV_CMD_SCRIPTING), [MAV_CMD_NAV_SCRIPT_TIME](#MAV_CMD_NAV_SCRIPT_TIME), [MAV_CMD_NAV_ATTITUDE_TIME](#MAV_CMD_NAV_ATTITUDE_TIME), [MAV_CMD_GUIDED_CHANGE_SPEED](#MAV_CMD_GUIDED_CHANGE_SPEED), [MAV_CMD_GUIDED_CHANGE_ALTITUDE](#MAV_CMD_GUIDED_CHANGE_ALTITUDE), [MAV_CMD_GUIDED_CHANGE_HEADING](#MAV_CMD_GUIDED_CHANGE_HEADING)
