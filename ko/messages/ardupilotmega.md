...
> **Warning** The ArduPilot MAVLink fork of [ardupilotmega.xml](https://github.com/ArduPilot/mavlink/blob/master/message_definitions/v1.0/ardupilotmega.xml) may contain messages that have not yet been merged into this documentation. The documentation below may not be accurate if the dialect owner has not pushed changes.
...
| -------------------------- | ------- | -------- |
| [Messages](#messages)      | 65      | 241      |
| [Enums](#enumerated-types) | 45      | 158      |
...
<span class="warning"><strong>DEPRECATED:</strong> Replaced By <a href="#MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS">MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS</a> (2014-07)</span>
...
| <span class='ext'>freemem32</span> [++](#mav2_extension_field) | `uint32_t` | bytes | Free memory (32 bit). |
...
| <span class='ext'>mount_mode</span> [++](#mav2_extension_field) | `uint8_t` |       | [MAV_MOUNT_MODE](#MAV_MOUNT_MODE) | Mount operating mode. |
...
<span class="warning"><strong>DEPRECATED:</strong> Replaced By <a href="#BATTERY_STATUS">BATTERY_STATUS</a> (2017-04)</span>
...
| <span class='ext'>airspeed_variance</span> [++](#mav2_extension_field) | `float`    |                                         | Airspeed variance.            |
...
| I                                                     | `float`   |                                       | I component.                                                          |
| D                                                     | `float`   |                                       | D component.                                                          |
| <span class='ext'>SRate</span> [++](#mav2_extension_field) | `float`   |                                       | Slew rate.                                                            |
| <span class='ext'>PDmod</span> [++](#mav2_extension_field) | `float`   |                                       | P/D oscillation modifier.                                             |
...
| <span class='ext'>bank</span> [++](#mav2_extension_field) | `uint8_t`  |                                           | Bank number.                     |
