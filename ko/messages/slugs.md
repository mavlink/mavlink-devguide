...
<table class="sortable">
   ...
   <tbody>
    ...
    <tr id="MAV_CMD_RETURN_TO_BASE">
     <td>10011</td>
     <td>
      <a href="#MAV_CMD_RETURN_TO_BASE">MAV_CMD_RETURN_TO_BASE</a>
     </td>
     <td>Return vehicle to base.</td>
    </tr>
    <tr>
     <td>
     </td>
    ...
    <tr id="MAV_CMD_STOP_RETURN_TO_BASE">
     <td>10012</td>
     <td>
      <a href="#MAV_CMD_STOP_RETURN_TO_BASE">MAV_CMD_STOP_RETURN_TO_BASE</a>
     </td>
     <td>Stops the vehicle from returning to base and resumes flight.</td>
    </tr>
    <tr id="MAV_CMD_TURN_LIGHT">
     <td>10013</td>
     <td>
      <a href="#MAV_CMD_TURN_LIGHT">MAV_CMD_TURN_LIGHT</a>
     </td>
     <td>Turns the vehicle's visible or infrared lights on or off.</td>
    </tr>
    <tr>
     <td>
     </td>
    ...
    <tr id="MAV_CMD_GET_MID_LEVEL_COMMANDS">
     <td>10014</td>
     <td>
      <a href="#MAV_CMD_GET_MID_LEVEL_COMMANDS">MAV_CMD_GET_MID_LEVEL_COMMANDS</a>
     </td>
     <td>Requests vehicle to send current mid-level commands to ground station.</td>
    </tr>
    <tr id="MAV_CMD_MIDLEVEL_STORAGE">
     <td>10015</td>
     <td>
      <a href="#MAV_CMD_MIDLEVEL_STORAGE">MAV_CMD_MIDLEVEL_STORAGE</a>
     </td>
     <td>Requests storage of mid-level commands.</td>
    </tr>
    <tr>
     <td>
     </td>
...
<p>Slugs-specific navigation modes.</p>
...
<p>These flags encode the control surfaces for selective passthrough mode. If a bit is set then the pilot console
...
<p>Sensor and DSC control loads.</p>
...
<p>Accelerometer and gyro biases.</p>
...
<p>Configurable diagnostic messages.</p>
...
<p>Data used in the navigation algorithm.</p>
...
<p>Configurable data log probes to be used inside Simulink</p>
...
<p>Mid Level commands sent from the GS to the autopilot. These are only sent when being operated in mid-level commands mode from the ground.</p>
...
<p>This message sets the control surfaces for selective passthrough mode.</p>
...
<p>Orders generated to the SLUGS camera mount.</p>
...
<p>Control for surface; pending and order to origin.</p>
...
<p>Transmits the last known position of the mobile GS to the UAV. Very relevant when Track Mobile is enabled</p>
...
<p>Transmits the position of watch</p>
...
<p>Transmits the readings from the voltage and current sensors</p>
...
<p>Transmits the actual Pan, Tilt and Zoom values of the camera unit</p>
...
<p>Transmits the actual status values UAV in flight</p>
...
<p>This contains the status of the GPS readings</p>
...
<p>Transmits the diagnostics data from the Novatel OEMStar GPS</p>
...
<p>Diagnostic data Sensor MCU</p>
...
<p>The boot message indicates that a system is starting. The onboard software version allows to keep track of onboard soft/firmware revisions. This message allows the sensor and control MCUs to communicate version numbers on startup.</p>
